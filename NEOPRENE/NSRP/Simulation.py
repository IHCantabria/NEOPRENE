...
class Simulation(object):
    ...
    def __call__(self, params_cal):
        ...
        if self.hiperparams.process=='normal':
            ...
            Df_sim_join_hour_['Rain']=Df_sim_join_hour_1.values.flatten()+Df_sim_join_hour_2.values.flatten()
            Df_sim_join_day_=pd.DataFrame(index=Df_sim_join_day_2.index)
            Df_sim_join_day_['Rain']=Df_sim_join_day_1.values.flatten()+Df_sim_join_day_2.values.flatten()
